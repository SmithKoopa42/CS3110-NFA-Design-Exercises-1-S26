...
1. The problems that gave me the most trouble were 11 and 24 because I was explicitly trying to minimize them. In 11's case I believe I managed to minimize it
   successfully, but for 24 I decided to just go with the simple solution instead. I didn't necessarily avoid any problems - I chose which ones to do via a
   random number generator. I did not ask questions to the instructor or AI.
